"""Image generation route coverage for ``POST /v1/images/generations``.

The test registers the deterministic demo image model, signs up for an API key,
and asserts generated bytes land in the blob store and remain retrievable.
"""
...
def client(tmp_path, monkeypatch):
    ...
    # Register the deterministic demo image model into the app registry built at lifespan startup.
